...
These commands assume `projects/data-harvesting/mlflow_server/.env` is configured, the rclone OneDrive
remote is available at `projects/data-harvesting/mlflow_server/rclone/rclone.conf`, and the Compose stack
is running.

Run them from `projects/data-harvesting/mlflow_server/`.
